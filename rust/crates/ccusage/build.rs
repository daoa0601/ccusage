...
fn is_embedded_model(model: &str) -> bool {
    model.starts_with("claude-")
        ...
        || model.starts_with("gemini/")
        || model.starts_with("gmi/google/gemini-")
        || model.starts_with("openrouter/google/gemini-")
        || model.starts_with("vertex_ai/gemini-")
        || model.starts_with("zai/")
        || model.starts_with("zai.")
        || model.starts_with("openrouter/z-ai/")
        || model.starts_with("vertex_ai/zai-org/")
        || model.starts_with("novita/zai-org/")
        || model.starts_with("cerebras/zai-glm-")
        || model.starts_with("vercel_ai_gateway/zai/")
}
